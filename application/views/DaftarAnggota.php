						...
						?>	
							...
							<tr>
								...
								<td>
									...
									<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" data-no-induk="<?php echo $row->no_induk; ?>" data-nama="<?php echo $row->nama; ?>" data-url="<?php echo current_url();?>">Hapus</button>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('Anggota/deleteAnggota'); ?>" method="post">
...
$(document).ready( function () {
	...
	$('#deleteModal').on('show.bs.modal', function (event) {
		  ...
		  modal.find('input','.nip').val(no_induk)
